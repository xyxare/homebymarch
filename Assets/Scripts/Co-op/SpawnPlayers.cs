    ...
    void Start()
{
    ...
    if (playerController != null)
    {
        ...
        {
            instantiatedJoystick = Instantiate(joystickPrefab, uiCanvas.transform); // Parent to the canvas
            instantiatedJoystick.transform.localPosition = new Vector3(245, 246,0); // Adjust position as needed
